...
The complete code may be viewed  <a href = "https://github.com/homerhanumat/shinyTutorials/blob/master/example_sim_01/app.R" target = "_blank">here</a>.  Since it's not a great deal of code, we also show it below:
