...
As you move beyond simulation apps you will want to incorporate other Shiny capabilities.  For example, the following two apps write information to an internal file so that students can compare their work with their classmates:

* <a href = "http://homer.shinyapps.io/FindRegLine" target = "_blank">FindRegLine</a>
* <a href = "http://homer.shinyapps.io/GetToKnow" target = "_blank">GetToKnow</a>

Source code for the above apps may be examined at my <a href = "https://github.com/homerhanumat/shinyGC" target = "_blank">Shiny-app repostitory on GitHub</a>.
